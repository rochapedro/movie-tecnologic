<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/drives') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Drives</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#product_collapse" class="nav-link"
                    aria-controls="product_collapse" role="button" aria-expanded="false">
                    <div
                    ...
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ url('admin/products') }}">
                                ...
                                <span class="sidenav-normal"> Todos os produtos </span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        ...
        const nav_items = document.querySelectorAll("li.nav-item");

        nav_items.forEach(function(link) {
            if (page_url.includes(link.href)) {
                console.log('ACTIVE');
